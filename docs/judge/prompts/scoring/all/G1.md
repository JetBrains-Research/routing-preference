...
1. The task description, a request to build a project from scratch
2. A patch.diff representing the proposed solution, containing the files the Agent created for the task
3. Any starting files that were provided to the Agent for the task (may be none)
...
### <CHARACTERISTIC_1_NAME.md>
<CHARACTERISTIC_1_SCORING_STEPS_G1.md>

### <CHARACTERISTIC_2_NAME.md>
<CHARACTERISTIC_2_SCORING_STEPS_G1.md>

### <CHARACTERISTIC_3_NAME.md>
<CHARACTERISTIC_3_SCORING_STEPS_G1.md>

### <CHARACTERISTIC_4_NAME.md>
<CHARACTERISTIC_4_SCORING_STEPS_G1.md>
