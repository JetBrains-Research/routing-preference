...
The solution stays within scope for the most part but includes one minor unrelated or unnecessary change, for example a small formatting fix or an incidental rename that is not part of what should have been fixed.
